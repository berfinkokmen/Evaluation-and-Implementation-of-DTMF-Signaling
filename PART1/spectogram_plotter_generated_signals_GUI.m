function spectogram_plotter_generated_signals_GUI(axes,generated_signal,window_length,window_shift,window_type,sampling_frequency_div2)
    ...
    frequency_values = linspace(0,sampling_frequency_div2,window_length*50); %The default fs = 4000
    ...
    colorbar(axes);
    ylim(axes,[0 sampling_frequency_div2]);
    xlim(axes,[0 size(STFT,1)]);
    yticks(axes,linspace(0, sampling_frequency_div2, 6)); 
